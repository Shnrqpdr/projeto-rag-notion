...
# MUDE ESSE TEMPLATE PARA FORNECER AS RESPOSTAS NA ESTRUTURA QUE VOCê DESEJA
# aqui, voce usará técnicas de prompt engineering
...
st.title("🔗 Bem vindo ao seu notion Pedro!")


with st.form("my_form"):
    text = st.text_area("O que você gostaria de saber?:", "")
